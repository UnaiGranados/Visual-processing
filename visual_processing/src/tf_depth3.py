...
def callback(ros_rgb, ros_depth):
    ...
    depth_frame = br.imgmsg_to_cv2(ros_depth, desired_encoding="16UC1")
    rgb_frame = br.imgmsg_to_cv2(ros_rgb, desired_encoding="rgb8")
    ...
    for r in results:
        ...
        tf=publish_transform(T_tag_cam,"camera_color_optical_frame" , "tag_frame" + str(i), ros_rgb.header.stamp)
        i = i+1
